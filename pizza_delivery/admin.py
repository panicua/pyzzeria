...
class DishAdmin(admin.ModelAdmin):
    ...
    list_filter = ("price", "price", "weight", )
    search_fields = ("id", "name", )


@admin.register(DishOrder)
class DishOrderAdmin(admin.ModelAdmin):
    list_display = ("id", "order", "dish", "dish_amount", )
    list_display_links = ("id", "dish", "order", )
    list_editable = ("dish_amount", )
    list_filter = ("order", )
    search_fields = ("id", "dish", "order", )
...
class CustomerAdmin(UserAdmin):
    ...
    search_fields = ("id", "first_name", "last_name", "email", "phone_number", "username", )
